...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using SAURABH BOTS:\n\n"
        ...
        f"**If you have any questions, feel free to ask [SAURABH BOTS🐦](https://t.me/+MdZ2996M2G43MWFl)! 💬**\n"
        )
    ) 
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [SAURABH BOTS🐦](https://t.me/+MdZ2996M2G43MWFl)"
